...
import { LogOut, User, Users, Clock, Ban, X, Loader2, Moon, TrendingDown, Bell, ChevronRight } from 'lucide-react';
          ...
          <div className="flex flex-wrap gap-2">
            {DIETARY_OPTIONS.map(opt => (
              <Badge
                ...
                className="cursor-pointer select-none rounded-xl px-3 py-1"
