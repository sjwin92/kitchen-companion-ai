...
import { Refrigerator, Snowflake, Archive, Pencil, Trash2, Check, PackageOpen } from 'lucide-react';
            ...
            >
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-muted-foreground mt-1 flex items-center gap-1.5">
                  ...
                  <span>Added {new Date(item.dateAdded).toLocaleDateString('en-GB', { day: 'numeric', month: 'short' })}</span>
                </div>
              </div>
