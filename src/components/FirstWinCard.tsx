...
import { Check, Package, CalendarDays, Camera, ShoppingCart, ChefHat, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="glass-card p-4 space-y-3 animate-fade-in border-primary/20">
      <div className="flex items-center gap-2">
        ...
        <span className="text-[10px] text-muted-foreground ml-auto">{progress.completedCount}/{progress.totalSteps}</span>
      </div>
