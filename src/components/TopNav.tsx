...
import { Home, Package, UtensilsCrossed, Calendar, ShoppingCart, Settings, Search, Menu, User } from 'lucide-react';
          ...
          <nav className="flex items-center gap-1">
            {NAV_ITEMS.map(({ to, label }) => (
              <NavLink
                ...
                to={to}
                className={({ isActive }) =>
                  `px-3.5 py-1.5 text-[10px] font-bold tracking-[0.14em] uppercase rounded-md transition-all ${
                    isActive
