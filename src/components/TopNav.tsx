...
const SEARCH_DESTINATIONS = [
  ...
  { path: '/recipe-books', label: 'Recipe books', description: 'Your collectable recipe shelf', keywords: 'creator collection yoto cookbook', icon: BookOpen },
  { path: '/meals', label: 'Smart recipe picks', description: 'Recipes matched to your kitchen', keywords: 'suggestions cook', icon: Heart },
