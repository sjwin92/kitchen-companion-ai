-- Phase 2 allocates £7 to vision, £2 to text/drafting, and keeps £1
-- uncommitted as a reserve. Replace the initial £8 vision guard while
-- preserving the transaction-level advisory lock and hard £10 ceiling.
...
comment on function public.reserve_ai_budget(uuid, text, text, text, numeric) is
  'Atomic Phase 2 AI reservation: £7 vision, £2 text, £1 reserve, £10 hard ceiling.';
